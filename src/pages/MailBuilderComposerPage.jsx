...
import ActualEditor from '../components/email/MailBuilder/ActualEditor';
import { getAutomationEmailTemplate } from '../services/email-automation/EmailTemplates';

export default function MailBuilderComposerPage() {
